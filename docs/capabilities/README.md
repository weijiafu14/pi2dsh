...
**111 upstream-shaped Pi rule rows total** — 25 same semantics · 83 mapped, difference stated · 3 not available — plus **217 imported symbols** from the three Pi runtime
